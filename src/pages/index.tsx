...
export default function Home() {
  ...
  return (
    <HomeContainer ref={sliderRef} className="keen-slider">
      ...
      <Product className="keen-slider__slide">
        <Image src={tshirt3} width={520} height={480} alt="camiseta com estampa de um foguete decolando"/>
      ...
      <Product className="keen-slider__slide">
        <Image src={tshirt4} width={520} height={480} alt="camiseta com estampa de um foguete decolando"/>
